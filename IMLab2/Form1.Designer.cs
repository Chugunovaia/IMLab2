namespace IMLab2
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.First = new System.Windows.Forms.NumericUpDown();
			...
			series1.LegendText = "Первая валюта";
			series1.Name = "Series1";
			series2.BorderWidth = 3;
			series2.ChartArea = "ChartArea1";
			series2.ChartType = System.Windows.Forms.DataVisualization.Charting.SeriesChartType.Line;
			series2.Legend = "Legend1";
			series2.LegendText = "Вторая валюта";
			series2.Name = "Series2";
			this.chart1.Series.Add(series1);
			this.chart1.Series.Add(series2);
			this.chart1.Size = new System.Drawing.Size(1326, 498);
			...
			// First
			// 
			this.First.DecimalPlaces = 10;
			this.First.Location = new System.Drawing.Point(22, 23);
			this.First.Name = "First";
			this.First.Size = new System.Drawing.Size(120, 22);
			this.First.TabIndex = 4;
			this.First.Value = new decimal(new int[] {
            9075,
            0,
            0,
            131072});
			this.First.ValueChanged += new System.EventHandler(this.numericUpDown1_ValueChanged);
			// 
			// Second
			// 
			this.Second.DecimalPlaces = 10;
			this.Second.Location = new System.Drawing.Point(22, 56);
			...
			this.ClientSize = new System.Drawing.Size(1338, 594);
		...
		private System.Windows.Forms.NumericUpDown First;
